...
// -- Si je veux connaître le nombre d'éléments de mon tableau ?
...
console.log(Prenoms[4]); // -- Freddy

// --
var i = 3;
console.log(Prenoms[i]); // -- Freddy

// -- Pour i = 0 (Au départ i vaut 0) ; tant que i est strictement inférieur à "NombreElementsDansMonTableau" (Prenoms.length) ; alors
// -- alors i++ (Incrémentation par pas de 1)
...
console.log("Prénoms = " + Contact.prenom);
console.log("Noms = " + Contact.nom);
...
// -- Comment accéder aux valeurs de mon objet, dans un tableau indexé !
    ...
    // -- En résumé, j'accède à la valeur de l'indice "prenom" de l'objet situé à l'index 3 de mon tableau "Contacts"
    ...
    // -- En résumé, j'accède à la valeur de l'indice "prenom" de l'objet situé à l'index 2 de mon tableau "Contacts".
